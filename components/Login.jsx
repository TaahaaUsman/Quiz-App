    ...
    <div className="flex min-h-screen items-center justify-center px-4 bg-gray-100">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
        ...
        <div className="mb-6 flex flex-col space-y-3">
          <button className="flex cursor-pointer items-center justify-center gap-3 rounded-md border border-gray-300 py-2 text-gray-700 hover:bg-gray-100 transition duration-200 transform hover:scale-105">
            <FcGoogle size={20} />
            Login with Google
          </button>
          <button className="flex cursor-pointer items-center justify-center gap-3 rounded-md border border-gray-300 py-2 text-gray-700 hover:bg-gray-100 transition duration-200 transform hover:scale-105">
