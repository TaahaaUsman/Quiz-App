              ...
              <div className="mt-0 flex flex-row gap-4 w-auto">
                <div>
                  <div className="flex w-full md:w-auto">
                    <button
                      onClick={handleFirst}
                      className="bg-[#c19026d5] text-black py-2 w-24 rounded-l-md border-r border-black flex items-center justify-center gap-1 hover:bg-opacity-80 active:scale-95 transition"
                    >
                      <FaAngleLeft
                        style={{ fontSize: "1rem", color: "black" }}
                      />
                    ...
                    <button
                      onClick={handleLast}
                      className="bg-[#c19028d5] text-black py-2 w-24 rounded-r-md border-l border-black flex items-center justify-center gap-1 hover:bg-opacity-80 active:scale-95 transition"
                    >
                      <span>Last</span>
                      <FaAngleRight
                        style={{ fontSize: "1rem", color: "black" }}
                ...
                {isMobile ? (
                  ...
                  <div>
                    <div className="flex w-auto">
                      ...
                      <button
                        onClick={handleNext}
                        className="bg-[#c19028d5] border-l rounded-r-md text-black py-2 w-24 border-black flex items-center justify-center gap-1 hover:bg-opacity-80 active:scale-95 transition"
                      >
                        <span>Next</span>
                        <FaAngleRight
                          style={{ fontSize: "1rem", color: "black" }}
                      ...
                      <button
                        onClick={handleSubmit}
                        className="bg-[#34bfa3cd] rounded-md ml-4 text-white px-4 py-2 flex items-center justify-center gap-1 hover:bg-opacity-80 active:scale-95 transition"
                      >
                        <FaSave style={{ fontSize: "1rem", color: "white" }} />
                        <span>Save</span>
                      </button>
